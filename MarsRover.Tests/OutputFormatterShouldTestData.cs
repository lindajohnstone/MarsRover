...
namespace MarsRover.Tests
{
    ...
    {
        public static TheoryData<List<Square>, int, int, string[]>FormatMapNoRoverTestData =
        ...
        public static TheoryData<List<Square>, int, int, int, int, Direction, string[]> FormatMapWithRoverTestData =
        new TheoryData<List<Square>, int, int, int, int, Direction, string[]>
        {
                {
                    new List<Square>
                    {
